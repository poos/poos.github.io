...
### 之前的博客地址在这里[oschina/bieshixuan](https://my.oschina.net/bieshixuan/blog/2236855)。简单列举一下这个博客的值得纪念的文章，或者说值得提一下，避免大家绕弯路的文章。
...
至此也刚刚好总结10条，也算是见证了我成长的过程吧。大家喜欢的话收藏一下。另外**[github/poos](https://github.com/poos)**真的也是干货慢慢哦：[戳这里查看项目介绍](https://poos.github.io/about/)
...
### 已经归类总结的部分
#### 设计
[**app打点框架  & Aspects 运行时 -> Swift项目打点**](https://poos.github.io/2018/07/17/Swift项目打点/)
#### 基础
[**Swift理论和基础 -> Swift基础中需要注意的点**](https://poos.github.io/2018/09/09/Swift基础中需要注意的点/)
#### 优化
[**图片 & 代码 & 设置-> 项目优化-瘦身**](https://poos.github.io/2018/06/16/项目优化-瘦身/)
#### 工具
[**WebDriverAgent  && 脚本 -> 使用WebDriverAgent学习其他app布局,自动化测试**](https://poos.github.io/2018/07/07/使用WebDriverAgent学习其他app布局,自动化测试/)
#### 轮子
[**WebDriverAgent  && 脚本 -> 处理NavItem的点击范围**](https://poos.github.io/2018/07/01/处理NavItem的点击范围)
